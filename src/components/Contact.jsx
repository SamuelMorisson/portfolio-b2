    ...
    return (
        ...
        <div id="contact" className="flex flex-col items-center my-20 pt-20">
            <div className="flex flex-col items-center w-3/4">
                ...
                <div className="flex flex-col items-center w-full bg-slate-200 rounded-3xl shadow-xl py-3">
                    ...
                    <div className="flex flex-col items-center w-1/2 my-3">
                        <button className="w-2/3 font-inconsolata text-2xl border-2 border-slate-300 hover:border-lime-500 hover:shadow-md py-2">Envoyer</button>
                    </div>
                </div>
