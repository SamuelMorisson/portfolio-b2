            ...
            <div className="w-3/4">
                ...
                <div className="grid grid-cols-2 place-items-stretch">
                    <div id="projet1" className="flex flex-col items-center bg-slate-200 rounded-3xl shadow-xl py-3 mr-4">
                        ...
                        <p className="w-3/4 my-3 p-1 border-2 border-slate-300 font-inconsolata text-xl">Création d`un tower defense en langage Python avec la librairie Pygame pour un projet scolaire</p>
                    </div>

                    <div id="projet2" className="flex flex-col items-center bg-slate-200 rounded-3xl shadow-xl py-3 ml-4">
                        <a href="https://github.com/data-fair/app-chord-diagram" target="_blank" rel="noopener noreferrer" className="font-inconsolata text-2xl font-semibold hover:text-lime-700 hover:underline">Diagramme Chord</a>
                        ...
                        <p className="w-3/4 my-3 p-1 border-2 border-slate-300 font-inconsolata text-xl">Contribution à la création d`une application de visualisation de données sous la forme d`un diagramme chord lors d`un stage</p>
                    </div>
                </div>
            </div>
        </div>
